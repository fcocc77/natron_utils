...
# Hand-written code should be added in a separate file named SpinExt.py
...
def createInstance(app,group):
    ...
    param.slaveTo(group.getParam("motion_blur"), 0, 0)
    del param

    try:
        extModule = sys.modules["SpinExt"]
    except KeyError:
        extModule = None

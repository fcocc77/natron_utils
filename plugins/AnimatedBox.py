...
# Hand-written code should be added in a separate file named AnimatedBoxExt.py
...
try:
    from AnimatedBoxExt import *
except ImportError:
    pass

def getPluginID():
    return "vv.AnimatedBox"
...
def createInstance(app,group):
    ...
    if param is not None:
        param.setValue("animated_box.main")
        del param
    ...
    param = lastNode.createChoiceParam("input_box", "Input")
    entries = [ ("Left", ""),
    ("Right", ""),
    ("Up", ""),
    ("Down", ""),
    ...
    param.setAnimationEnabled(True)
    param.set("Up")
    lastNode.input_box = param
    del param

    param = lastNode.createChoiceParam("output_box", "Output")
    entries = [ ("Left", ""),
    ("Right", ""),
    ("Up", ""),
    ("Down", ""),
    ...
    grouprectangle.connectInput(0, groupReformat2)
    grouptransform.connectInput(0, grouprectangle)
    ...
    del param
    try:
        extModule = sys.modules["AnimatedBoxExt"]
    except KeyError:
        extModule = None

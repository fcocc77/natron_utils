...
def createInstance(app,group):
    ...
    if param is not None:
        param.setValue(315.8, 0)
        param.setValue(177.2, 1)
        del param

    param = lastNode.getParam("size")
    if param is not None:
        param.setValue(1289.07, 0)
        param.setValue(725.5999999999999, 1)
        del param

...
def distribute(thisNode):
    ...
    for i in range(1, repetitions + 1):
        width_translate = thisNode.getNode('shape_width_' + str(i)).getParam('translate')
        ...
        if sort == 1: # Formas ordenadas
            ...
            width_dst = -(part + 1)
            directional_transition(width_translate, duration, exaggeration_time, exaggeration_value, _start_frame, [width_src, width_dst])
        else: # Formas Random
